...
--
-- Client :  127.0.0.1
-- Généré le :  Ven 31 Juillet 2015 à 17:58
...
INSERT INTO `user` (`id`, `firstname`, `lastname`, `pseudo`, `email`, `password`, `newsletter`, `cgu`, `register_date`) VALUES
(1, '', '', 'Iskandir', 'manalegende2@gmail.com', 'iskandir13', NULL, NULL, '0000-00-00 00:00:00'),
(2, 'Antoine', 'Dupuy', 'Draazen', 'a.dupuy.pro@gmail.com', '$2y$10$8LaAfW9YVbiVv6sAyLCF8uO5/aHIbdGEo669lH1B7Eno4yzF2TVFi', 0, 1, '2015-07-30 12:29:03');
